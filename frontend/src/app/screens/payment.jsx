            ...
            <div className='page-size fading checkout-screen'>
                ...
                <form className="form shipping-form" onSubmit={handleForm}>
                    ...
                    <div className="payment">
                        ...
                        <div className="flex">
                            <input type="radio" required onClick={(e) => { setPaymentMethod(e.target.value) }} name="payment" id="flutterwave" value="Flutterwave" />
                    ...
                    <input type="submit" disabled={paymentMethod === false ? true : false} className={paymentMethod === false ? "btn-disabled" : ""} value={paymentMethod === false ? "Select a payment method!" : "Continue"} />
                </form>
                <br />
            </div>}
        </>
